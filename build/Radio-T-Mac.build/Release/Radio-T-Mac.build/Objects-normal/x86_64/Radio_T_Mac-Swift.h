...
#ifndef RADIO_T_MAC_SWIFT_H
#define RADIO_T_MAC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Radio_T_Mac",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11Radio_T_Mac18AudioPlayerManager")
@interface AudioPlayerManager : NSObject <AVPlayerItemMetadataOutputPushDelegate>
...
SWIFT_CLASS("_TtC11Radio_T_Mac19NotificationManager")
...
SWIFT_CLASS("_TtC11Radio_T_Mac16RadioAppDelegate")
